...
def optimal_rvec(target_id, target_rvec, gripper_opening, finger_wdith, finger_location, detection_obj, mask_type="bb", prune_factor=2, num_steps=360):        
    best_rvec = None
    ...
    try:
        ...
        if cands:
            ...
            return best_rvec, cands[0]["rvec"], tvec_to_cam
    ...
    """
    def closest_pose(pose_candidate, robot, joint, freedom={"num":200, "range":[2, 2, 2], "early_exit":True }):
        return robot.kinematic.nearest_pose(pose_candidate, joint, freedom)[3:6]
    """