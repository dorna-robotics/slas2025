...
decapper = {
    ...
    "frame": [309.7755063457461, -31.259957029685296, 2.125313751147658, 179.921895632902, -0.19910736926562048, -0.12929285321837136],

    "15ml_cap": [25, 8.75, -tube["15ml"]["height"], 0, 0, 0],
    #"15ml_cap": [22.798176783140775, 3.1660670419544203, -121.0563977696934, -0.005362523643205572, -0.029482697114558285, 0.0463906712373938],

    "15ml_cap_loose": [25, 8.75, -tube["15ml"]["height"]-15, 0, 0, -90],
    "50ml_cap": [25, 34.75, -tube["50ml"]["height"], 0, 0, 0],
    #"50ml_cap": [23.00750486818953, 28.32739068129508, -116.99395600962706, -0.059631911532280084, -0.13883598054225965, 0.007128033171633476],

    "50ml_cap_loose": [25, 34.75, -tube["50ml"]["height"]-15, 0, 0, -90],
...
detection_preset = {
    "tube":{
        "camera_mount":{
            "type": "dorna_ta_j4",
            "ej": [0 ,0, 0, 0, 0, 0, 0, 0],
            "T": [46.5174596+1+1+0+4-(1), 32.0776662-3+1-0-1.5+(-1), -4.24772615-3-2, -0.27547989, 0.27691881, 89.6939516],
        },
...
scanner_to_decapper = {
    ...
    "place": {
        ...
        "tool": [None, None],
        "output": None,
        "approach": [[0, 0, -140, 0, 0, 0], [0, 0, -60, 0, 0, 0]],
    },
    "base_in_world": robot["base_in_world"],
    "aux_dir": robot["aux_dir"],
    "sleep": 0.5, 
